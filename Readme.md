...
> 현대인들은 감정을 소비할 일이 많고 부정적인 감정을 느끼는 상황이 종종 발생합니다.
> 전문가들은 부정적인 감정을 전환하려면 자신의 감정을 직시하고, 그 순간의 상황과 감정을 기록하여 모니터링하는 것이 효과적이라고 합니다. <br />
> 하지만 이러한 감정을 기록하는 것은 쉽지 않습니다.
> 사용자 본인이 어떤 기분인지 정확히 알 수 없고, 감정을 기록하기 위한 일기를 꾸준히 쓰기 어렵습니다. <br />
> 저희는 이러한 문제를 해결하면서 일기를 쓰며 기분 전환도 되었으면 좋겠다는 생각에서 `Bloomer`를 기획하게 되었습니다.
